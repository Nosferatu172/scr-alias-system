#!/usr/bin/env python3
# Script Name: restores-music-mp3-wsl-4.py
# ID: SCR-ID-20260317131052-7PK2FV0BV2
# Assigned with:
# Created by: Tyler Jensen
# Email: tylerjensen5@yahoo.com
# Alias Call: restores-music-mp3-wsl-4
...
custom_prefix = 'yt-dlp -x --audio-format mp3 -o "%(title)s.%(ext)s" -P /mnt/c/Users/tyler/Music/clm-mp4/ "'
