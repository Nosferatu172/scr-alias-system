...
def set_version(version, local=False):
    if local:
...
def main():
    ...
    parser.add_argument("--local", action="store_true", help="set local version instead of global")
    ...
    set_version(choice, local=args.local)
