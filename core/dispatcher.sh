...
# ID: SCR-ID-20260412153524-KWOUJJYMF6
# Assigned with:
# Created by: Tyler Jensen
# Email: tylerjensen5@yahoo.com
# Alias Call: dispatcher
...
show_help() {
    cat <<EOF
SCR Dispatcher
SCR IS NOT ACTIVE FOR EDIT MODE
PLEASE CALL scr0
Usage:
  scr0 <command> [args]
  scr0 e-<command>     Edit target
  scr0 v-<command>     View target
  scr0 c-<command>     Cd into target directory
